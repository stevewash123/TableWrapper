...
import { ColumnConfigPanelComponent } from '../column-config-panel/column-config-panel.component';
...
@Component({
  ...
  templateUrl: './table-wrapper-demo.component.html',
  styleUrl: './table-wrapper-demo.component.css',
  standalone: true
})
export class TableWrapperDemoComponent implements OnInit {
  ...
  switchDemo(demo: 'users' | 'products'): void {
    this.selectedTable = demo;
    this.onTableChange(demo);
  }
